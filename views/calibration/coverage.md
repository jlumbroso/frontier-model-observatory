...
|---|---|---|
| `calibration/anthropic/claude-4` | partially_covered | Diff the two live versions and extract changed claims. |
| `calibration/anthropic/claude-fable-5-1-mythos-5-1` | partially_covered | Encode the companion risk report and safeguard-regime claims. |
| `calibration/anthropic/claude-opus-4-6` | partially_covered | Extract four dated changelog blocks and correction claims. |
| `calibration/anthropic/claude-opus-5-system-prompt` | partially_covered | Extract the prompt block, product scope, API non-applicability, and model identifiers. |
...
| `calibration/openai/sora-2` | partially_covered | Record the apparent PDF redirect and typed nonavailability without fabricating PDF bytes. |
